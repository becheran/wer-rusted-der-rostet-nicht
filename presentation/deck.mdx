...
die **explizit Speicher allozieren und freigeben** müssen.
...
auf dem *Heap* verwendet wird und falls nicht, diese Ressourcen wieder für andere Prozesse freigibt.
...
reserviert wird (*memory leak*), oder falls versehentlich bereits freigegebener Speicher erneut 
...
Bei Rust wird bereits beim Übersetzen des Programms geprüft, ob es zu eventuellen Speicherproblemen kommt. 
...
* Viele moderne und hilfreiche Sprachfeatures
